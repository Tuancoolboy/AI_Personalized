  ...
  select jsonb_build_object(
    ...
    'participant_count', (
      ...
      where players.room_id = rooms.id
        and (not players.is_host or rooms.host_mode = 'human')
    ),
...
-- rollback:
-- Reapply the prior preview/join function definitions where every is_host
-- participant is excluded from participant_count and room capacity.
